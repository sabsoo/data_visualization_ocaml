...
let () =
  Plot.to_svg (Plot.curve_plot (0.) (1.) cos) "curve_plot_cos.svg"
let () =
  Plot.to_svg (Plot.curve_plot (0.) (1.) sin) "curve_plot_sin.svg"
let () =
  Plot.to_svg (Plot.curve_plot (-1.) (1.) funct) "curve_plot_funct.svg"
let () =
  Plot.to_svg (Plot.curve_plot (0.) (1.) f_carre) "curve_plot_carre.svg"
let () =
  Plot.to_svg (Plot.curve_plot (0.) (1.) sqrt) "curve_plot_sqrt.svg"
